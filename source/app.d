...
import window_manager_subsystem : WindowManagerSubsystem;
import trinove.gpu.rhi : RHI;

version (TrinoveDebugServer) import trinove.debug_server_subsystem : DebugServerSubsystem;
...
int main(string[] args)
{
	...
	SubsystemManager.register(new WindowConductor());
	SubsystemManager.register(new WindowManagerSubsystem());
	SubsystemManager.register(new WaiCompositor());
	version (TrinoveDebugServer)
		SubsystemManager.register(new DebugServerSubsystem());
