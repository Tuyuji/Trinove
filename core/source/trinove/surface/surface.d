...
final class WaiSurface : WlSurface
{
	...
	@property bool tracingEnabled() const
	{
...
// Find the topmost visible surface (main surface or any subsurface) at compositor-space
// cursor position. The caller provides the main surface's compositor-space origin
// (from View.contentOrigin()) and its logical size.
SurfaceHit findSurfaceAt(WaiSurface root, Vector2I origin, Vector2I rootSize, Vector2I cursor)
{
	return findSurfaceAtAbs(root, null, origin, rootSize, cursor);
}
